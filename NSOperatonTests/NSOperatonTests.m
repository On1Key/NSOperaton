...
//  NSOperatonTests
//
//  Created by Yang Mr on 2017/8/10.
...
@interface NSOperatonTests : XCTestCase{
    CalculateManager *manager;
}

@end

@implementation NSOperatonTests
...
- (void)testExample {
    ...
    manager.add(10).add(11).add(12);
    manager.sumBlock(12,22);
    NSLog(@"res==%ld",manager.result);
}
